...
@TeleOp(name="WorkingImageDetectionBlake", group="AAAAAAAAAAAAAAAAAAAHHHH")

@Disabled
@Deprecated
public class WorkingImageDetectionBlake extends LinearOpMode{
    ...
    private static String MODEL_FILE_NAME = "/sdcard/FIRST/ExternalLibraries/SleveImageDetection.tflite";
