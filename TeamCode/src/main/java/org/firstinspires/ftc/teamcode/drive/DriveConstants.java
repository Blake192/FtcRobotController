...
//    gobilda 5203 series
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(11, 0.2, 12,
    ...
    public static double GEAR_RATIO = .9809121694; // output (wheel) speed / input (motor) speed
